...
btv.AbstractController = function(controlsDiv, treeDiv) {
    ...
    $('#startOver').button({
        disabled : false
    }).click(jsgl.util.delegate(this, this.startOver));
    ...
    if(str == 'BST '){
        var bstOperations = ['Generate Random BST', 'Insert', 'Find', 'Delete', 'Get Max', 'Get Min', 'Get Predecessor', 'Get Successor', 'To Preorder Array', 'To Inorder Array','To Postorder Array'];
        inflateSelect("operations",bstOperations);
    }
    if(str == 'AVL '){
        var avlOperations = ['AVL Operation 1'];
        inflateSelect("operations",avlOperations);
    }
    })
    .change();
...
/**
 * Clear the screen as fresh.
 * 
 * @protected
 */
btv.AbstractController.prototype.startOver = function(){
    init();
}
...
btv.AbstractController.prototype.enableButtons = function() {
    ...
    $("#playPauseButton").button("option", "disabled", true).html('<i class="far fa-play-circle fa-3x media-icon"></i>');
...
btv.AbstractController.prototype.disableButtons = function() {
    ...
    $("#playPauseButton").button("option", "disabled", false).html('<i class="far fa-pause-circle fa-3x media-icon"></i>');
...
btv.AbstractController.prototype.playButton = function() {
    ...
    if(this.visualiser.playAnimation()) {
        ...
        $('#playPauseButton').html('<i class="far fa-pause-circle fa-3x media-icon"></i>');
    }
}
...
btv.AbstractController.prototype.pauseButton = function() {
    ...
    if(this.visualiser.pauseAnimation()) {
        ...
        $('#playPauseButton').html('<i class="far fa-play-circle fa-3x media-icon"></i>');
    }
}
...
/////////////////////////////////
    // get alg params
    var valueInput = document.getElementById("BSTDeleteText");
